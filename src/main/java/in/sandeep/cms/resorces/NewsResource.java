package in.sandeep.cms.resorces;

import in.sandeep.cms.models.News;
import in.sandeep.cms.models.Review;
import in.sandeep.cms.vo.NewsRequest;
...
public class NewsResource {
    ...
    public ResponseEntity<List<News>> findAll(){
        return ResponseEntity.ok(List.of(new News(),new News()));
    }
